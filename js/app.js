...
function sum(a, b) {
  let answer = a+ b;
  return [answer, 'The sum of 4 and 7 is 11.'];
}
...
function multiply(a, b) { //eslint-disable-line
  let product= a*b;
  let words= `The product of ${a} and ${b} is ${product}.`;
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  const productString = `The product of ${a} and ${b} and ${c} is ${productResult}.`;
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let resultString = numbersString + ' was passed in as an array of numbers, and ' + sum + ' is their sum.';
